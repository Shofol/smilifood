...
const Hero = () => {
  return (
    <div className="max-w-7xl mx-5 lg:mx-10 xl:mx-auto flex flex-col lg:flex-row items-start relative mt-36 lg:mt-48">
      ...
      >
        <h1 className="text-5xl font-bold mb-4">FastFood order online</h1>
        <h2 className="text-2xl pb-4 ">Increase the number of online orders</h2>
        <p className="text-lg lg:text-xl text-br-lgreen text-justify lg:pr-36 pl-4 border-l-4 border-l-br-primary">
          Stop wasting time answering the phone and increase your sales
        </p>
      </motion.div>
      <motion.div
        initial={{ scale: 0 }}
